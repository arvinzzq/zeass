...
var cwd = process.cwd();
var controllerPath = _path2.default.resolve(cwd, (0, _utils.pathConfig)('server'), 'controller');
var routerDefaultConfig = JSON.parse(_fs2.default.readFileSync(_path2.default.resolve(cwd, (0, _utils.pathConfig)('server'), 'router/default.json')) || {});
var routerConfigPath = _path2.default.resolve(cwd, (0, _utils.pathConfig)('server'), 'router/router.config');
